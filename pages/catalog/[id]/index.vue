...
<!--                    link: 'text-gray-300'-->
<!--                }"-->
<!--            :links="[{ label: 'Главная', to: '/' }, {label: 'Кровати', to: '/catalog'}, { label: cleanText(product?.title) }]"-->
<!--        />-->
...
<!--                  &lt;!&ndash; Показываем старую цену если есть скидка на выбранных опциях &ndash;&gt;-->
<!--                  <span-->
...
<!--      </div>-->
<!--&lt;!&ndash;      <ProductDescription/>&ndash;&gt;-->
...
<template>
  <main class="main">
    ...
    <!--    <MainForm/>-->
    <HomePay/>
    <HomeClients title="Наши партнеры" :items="itemsClients"/>
    <MainNewsList/>
  </main>
</template>

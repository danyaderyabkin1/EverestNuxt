...
<template>
  <section class="opt">
    <div class="opt__container container">
      <img class="hidden md:block" src="/assets/images/black-fr.svg" alt="friday">
      <div class="flex flex-col items-start relative pb-7">
        ...
        <form @submit.prevent="sendForm" class="flex flex-col items-stretch sm:items-start w-full">
            ...
            <div class="md:flex w-full md:w-2/5 md:items-center justify-center mb-4">
              <div class="w-full">
                ...
                <input
                    ...
                    name="user_name[Ваше имя]"
                    type="text"
                    placeholder="Короткое пожелание.."
                    required>
              </div>
            </div>
          </div>
          <UCheckbox color="gray" class="my-3" v-model="checkbox">
            <template #label>
              <span class="text-gray-600">Я даю согласие на обработку моих персональных данных ООО «Эверест» (ИНН ) в целях обработки заявки и обратной связи. <router-link class="text-gray-500" target="_blank" to="/assets/policyO.pdf">Политика конфиденциальности</router-link> </span>
            </template>
          </UCheckbox>
